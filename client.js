...
const authServer = {
	...
	tokenEndpoint: 'http://oauth-authorizationserver.cluster-ig5.igpolytech.fr/token'
}
 ...
 */
res.redirect(authServer.authorizationEndpoint+'?response_type=code&scope=foo&client_id='+client.client_id+'&redirect_uri='+client.redirect_uris)
...
app.get('/fetch_resource', (req, res) => {
	...
	let headers = {
		...
		'Authorization': 'Bearer '+ authServer //TODO
	}
